		...
		<div class="row">
			...
			<div class="col-md-8 col-xs-12">
				<article class="admin-dashboard">
					<h3 class="admin-welcome-title"><?php echo $_SESSION["firstname"] . ' ' . $_SESSION["lastname"];?>      Welcome to Doctor NTULI Pharmacy</h3>
					<img src="images/banner2.jpg" alt=" " class="img-responsive admin-image thumbnail">
				</article>
			</div>
		</div>
	</div>

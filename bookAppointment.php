			...
			<div class="col-md-8 col-xs-12">
				<article class="admin-dashboard margin-top">
					<div class="panel panel-primary">
						<div class="panel-heading"><h5 class="thin">Book an Appointment</h5></div>
							
							<div class="panel-body">
								 <form action="<?php echo $_SERVER['PHP_SELF'] ;?>" enctype="multipart/form-data" method="POST">
								<div class="col-md-12">
											 
											 <h4 class="heading">Select Visit Time</h4>
											 <hr class="hor">
								        </div>
								<div class="row">
											<div class="col-md-3">
												<div >
												 <label>Date</label>
											     <input type="date"  name="appointDate" id="appointDate"class="form-control" value="<?php echo date('Y-m-d'); ?>" >
												...
												<button type="submit" name="bookSub" class="btn btn-md btn-success">Book Now</button>

			...
			<nav class="navbar navbar-default">
				...
				<div class="navbar-header">
				  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
					...
					<div class="logo">
						<h1><a class="navbar-brand" href="index.php">BALOYI PHARMACY<i class="fa fa-users" aria-hidden="true"></i></a></h1>
					</div>
				</div>
...
<!-- banner1 -->
	<div class="banner1 jarallax">
		<div class="container">
			<marquee><h3 class="page-heading"><?php echo $_SESSION["firstname"] . ' ' . $_SESSION["lastname"];?> Welcome to DOCTOR BALOYI PHARMACY</h3></marquee>
		</div>
	</div>
		...
		<div class="row">
			...
			<div class="col-md-8 col-xs-12">
				<article class="admin-dashboard">
					<h3 class="admin-welcome-title"><?php echo $_SESSION["firstname"] . ' ' . $_SESSION["lastname"];?>(Admin) Welcome </h3>
					<img src="images/d1.jpg" alt=" " class="img-responsive admin-image thumbnail">
				</article>
			</div>
		</div>
	</div>

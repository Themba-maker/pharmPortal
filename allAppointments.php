      ...
      if(isset($_POST["cancelAppoint"])) {
		...
		if (isset($_POST["id"])) {
			...
			?>
				...
				var isOkay = window.confirm('Are you sure you want to cancel an appointment?');
				if (isOkay === true) {
					alert("<?php echo $funPatient->cancelAppointment($con, $id)?>");
				} 
				</script>
			<?php
		} else {
			...
			<div class="col-md-4 col-xs-12">
				<aside class="quick-links">
					<table class="table-responsive">
						...
						<tr>
							<td><li><a class="btn"  href="allAppointments.php">View your Appointments</a></li></td>
						</tr>
			...
			<div class="col-md-8 col-xs-12">
				<article class="admin-dashboard margin-top">
					<div class="panel panel-primary">
						<div class="panel-heading"><h5 class="thin text-center">Booked Appointments</h5></div>
							<div class="panel-body">
								<form action="<?php echo $_SERVER['PHP_SELF'] ;?>" method="POST">
									<?php
										require_once('dbConnect.php');
										$patientCode = $_SESSION["patientCd"];
										$result = $funPatient->getAppointments($con,$patientCode);
										if ($result != null ) {
											if ($result->num_rows > 0) {
												print '<table class="table table-bordered" width="40">
													...
													while($row = $result->fetch_assoc()) {
														...
														print"<tr class='info'><td><input type='radio' value='$id' name='id'/></td><td>$id</td><td>$date</td><td>$time</td></tr>";	
													}
													'</tbody>';
												print "</table>";
											?>
												
											<button class="btn btn-checkout" name="cancelAppoint" type="submit">Cancel Appointment</button>

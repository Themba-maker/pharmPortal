...
?>
        ...
        <body>
            ...
            <div class="about" id="about">
                <div class="container">
                    <h2 class="doctor_heade_tittle_agile">Unlimited conversations with Doctors</h2>
                    <p class="sub_t_agileits">  </p>
                    <p class="ab">Connect with a board-certified doctors to discuss symptoms, </p>
                     <p class="ab">answer specific questions, or get a second opinion. Chat all you want on your schedule—not when the doctor can fit you in.</p>
